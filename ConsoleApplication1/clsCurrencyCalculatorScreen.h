...
class clsCurrencyCalculatorScreen:protected clsScreen
{
	...
	{		
		...
		{
			cout << "\n\n There are no need to converting the currencies they are same currencies\n";
			return;
		...
		if (Currency1.CurrencyCode() == "USD")
		{
			...
			float AmountInCurrrency1 = Currency1.ConvertToOtherCurrency(Amount, Currency2);

			cout << fixed << setprecision(0);

			cout << Amount << " " << Currency1.CurrencyCode()
				<< " = " << AmountInCurrrency1 << " " << Currency2.CurrencyCode();
